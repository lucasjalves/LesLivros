...
<head>
	...
	/*
		...
		{
			$(document.getElementById('btnCartao')).click(function(){
				var txtIdCartao = $(this).attr("txtIdCartao");
				var txtIdCartaoFk = $(this).attr("txtIdCartaoFk");
				var operacao = "CONSULTAR";
				$.ajax({
					url: "SalvarCartao",
					method: "post",																							
					data: {txtIdCartao : txtIdCartao , operacao : operacao, txtIdCartaoFk : txtIdCartaoFk }, // AJAX
...
<body>
	...
	<table>
		<tr>
			<td>Email: <%out.print(p.getEmail()); %></td>
		</tr>
		<tr>
			<td>Nome: <%out.print(p.getNome()); %></td>
		</tr>
		<tr>
			<td>Genero: <%out.print(p.getGenero()); %></td>
		</tr>
		<tr>
			<td>CPF: <%out.print(p.getCpf()); %></td>
		</tr>
		<tr>
			<td>Data de Nascimento: <%out.print(ConverteDate.converteDateString(p.getDtNascimento())); %></td>
		</tr>
	</table>
